<?php
	...
	class apiSuccess extends apiParam{
		...
		protected $markdownFields = array('description','type');
		protected $markdownRemovePTags = array('type');
		...
		public function parse($content){
			...
			$this->group = !empty($this->res[1])?$this->res[1]:'Success 200';
			$res = array(
				'group'	=>	$this->group,
				'type'	=>	$this->res[2],
				'size'	=>	$this->res[3],
		...
		public function getPath(){
			return 'local.success.fields.'.$this->getGroup();
		}
	}